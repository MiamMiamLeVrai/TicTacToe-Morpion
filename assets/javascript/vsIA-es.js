...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function playAI() {
        ...
        cells[bestMove].setAttribute("aria-label", `Celda ocupada por IA (${aiSymbol})`);
        ...
        if (winner) { 
            winner.combo.forEach(i => {
                ...
                cells[i].setAttribute("aria-label", `Casillas ganadoras ocupadas por el jugador ${winner.symbol}`);
            });
    ...
    cells.forEach((cell) => {
        cell.addEventListener("click", () => {
            ...
            cell.disabled = true;
            cell.style.pointerEvents = "none";
            cell.setAttribute("aria-label", `El espacio ocupado por ti ${humanSymbol}`);
